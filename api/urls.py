...
urlpatterns = [
    ...
    path("order/<int:customer>/<int:pk>/", OrderitemDeleteAPIView.as_view(), name="orderitem-delete"),
    ...
    path("account/companyprofile/", CompanyProfileCreateAPIView.as_view(), name="companyprofile-create"),
]
